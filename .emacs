...
(custom-set-variables
 ...
 '(package-selected-packages '(evil-tutor doom-themes evil-visual-mark-mode dmenu exwm)))
(custom-set-faces
...
(setq exwm-workspace-number 10
      exwm-randr-workspace-output-plist '(0 "eDP-1"))(setq exwm-input-prefix-keys '(?\M-x
										    ?\M-:
										    ?\C-x)
