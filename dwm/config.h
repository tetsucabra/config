...
static const char col_cyan[]        = "#c274a4";
...
static const char *surfcmd[]  = { "tabbed", "-r", "2", "surf", "-pe", "x", "google.com", NULL };
static const char *vifmcmd[]  = { "termite", "-e", "vifm", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_f, spawn,          {.v = vifmcmd } },
